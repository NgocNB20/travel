...
formElement.onsubmit = (event) => { 
   ...
   if(check && window.location.pathname=="/register.html"){
       console.log(document.getElementsByClassName("btn_link"))
    document.getElementsByClassName("btn_link").href="./login.html"; 
   }else if(check && window.location.pathname=="/login.html"){
    document.getElementsByClassName("btn_link").href="./edit.html"; 
   }
