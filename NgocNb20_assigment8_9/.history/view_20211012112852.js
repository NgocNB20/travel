       ...
       <div class="col-10">
         <form id="form_input">
           <div class="form-group ">
             ...
             <input type="text" class="form-control" id="exampleFormControlInput1" id="title" name="title" 
               placeholder="Enter the title">
               <span class="form-message"></span>
           </div>
           <div class="form-group">
             <label for="exampleFormControlTextarea1" class="form-desc">Brief</label>
             <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" id="brief" name="brief"></textarea>
           </div>
           <div class="form-group">
             <label for="exampleFormControlTextarea1" class="form-desc">Content</label>
             <textarea class="form-control" id="exampleFormControlTextarea1" rows="6 name="content" id="content" "></textarea>
           </div>
           <div class="form-group">
