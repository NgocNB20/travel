    ...
    <div class="row form">
      <div class="col-10">
        <form id="form_input">
          ...
          <div class="form-group">
            <input class="btn btn-primary btn-submit" id="btn-add-submit" type="button" value="Submit Button">
          ...
          <div class="row form">
            <div class="col-10">
              <form id="form_input">
                ...
                <div class="form-group">
                  <input class="btn btn-primary btn-submit" id="btn-edit-submit" type="button" value="Submit Button">
                  <input class="btn btn-primary" id="btn_reset" type="button" value="Reset Button">
                </div>
              </form>
            </div>
